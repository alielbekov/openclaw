...
CMD ["sh", "-c", "node openclaw.mjs config set gateway.controlUi.allowedOrigins '[\"https://openclaw.alielbekov.dev\"]' && node openclaw.mjs gateway --bind lan --port 18789 --allow-unconfigured"]
